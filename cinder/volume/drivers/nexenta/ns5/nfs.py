...
class NexentaNfsDriver(nfs.NfsDriver):
    ...
    def create_volume(self, volume):
        ...
        try:
            ...
            try:
                ...
                LOG.debug('Unable to delete volume %(path)s: %(error)s',
        ...
        for attempt in range(0, attempts):
            try:
                ...
                if attempt == (attempts - 1):
                    LOG.error('Unable to unmount NFS share %(share)s '
                              'after %(attempts)s attempts',
                              {'share': share, 'attempts': attempts})
                    raise error
                LOG.warning('Unmount attempt %(attempt)s failed: %(error)s, '
    ...
    def migrate_volume(self, context, volume, host):
        ...
        for nef_ip in nef_ips:
            ...
            try:
                ...
                if nef_ip is None or error.code not in ('EINVAL', 'ENOENT'):
                    LOG.error('Unable to create replication '
        ...
        try:
            ...
            LOG.error('Unable to start replication '
            ...
            try:
                ...
                LOG.error('Unable to delete replication '
                          'service %(svc)s: %(error)s',
                          {'svc': svc, 'error': error})
            return false_ret
        ...
        try:
            ...
            LOG.warning('Unable to delete source volume %(volume)s: %(error)s',
    ...
    def create_cloned_volume(self, volume, src_vref):
        ...
        try:
            ...
            LOG.debug('Unable to create cloned volume: '
            ...
            try:
                ...
                LOG.debug('Unable to delete temporary snapshot '
